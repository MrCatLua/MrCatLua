...
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Text = "Central Public | Version: 2.3.4 "
GuiLibrary["MainGui"].ScaledGui.ClickGui.MainWindow.TextLabel.Text = "Central Public VERSION: 2.3.4"
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Version.Text = "Central Public V2"
